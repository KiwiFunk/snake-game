...
class Menu:
    ...
    def draw(self):
        ...
        title_image = pygame.image.load('assets/menugraphics/title.png')
        title_rect = title_image.get_rect(center=(self.grid_size * self.cell_size // 2, self.grid_size * self.cell_size // 4))
        self.screen.blit(title_image, title_rect)

        start_text = self.font.render("Press enter to StArt", True, (255, 255, 255))
        start_rect = start_text.get_rect(center=(self.grid_size * self.cell_size // 2, self.grid_size * self.cell_size // 1.8))
